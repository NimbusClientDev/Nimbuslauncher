...
import { NimbusCloudModal } from "./pages/shared-modals/nimbus-cloud/nimbus-cloud-modal";
...
export function App() {
  ...
  const { hideNimbusCloudModal, isNimbusCloudModalVisible, nimbusCloudFeature } =
    useSubscription();
  ...
  return (
    <>
      ...
      <NimbusCloudModal
        visible={isNimbusCloudModalVisible}
        onClose={hideNimbusCloudModal}
